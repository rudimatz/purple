...
DATATRACKER_RPC_API_BASE = os.environ.get("DATATRACKER_RPC_API_BASE", "http://host.docker.internal:8000/api/rpc")
DATATRACKER_RPC_API_TOKEN = os.environ["RPC_API_TOKEN"]
DATATRACKER_API_V1_BASE = os.environ.get("DATATRACKER_API_V1_BASE", "http://host.docker.internal:8000/api/v1")
