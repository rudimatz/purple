  ...
  <HeadlessTransitionRoot as="template" :show="isShown">
    <HeadlessDialog as="div" class="relative z-[100]" @close="close">
      <HeadlessTransitionChild
        ...
        leave-to="opacity-0">
        <div
          class="fixed inset-0 bg-gray-500 dark:bg-black bg-opacity-75 dark:bg-opacity-50 transition-opacity backdrop-blur" />
      </HeadlessTransitionChild>
      ...
      <div class="fixed inset-0 z-10 overflow-y-auto">
        <div
          ...
          <HeadlessTransitionChild
            ...
            <HeadlessDialogPanel
              class="relative transform overflow-hidden rounded-lg bg-white dark:bg-neutral-900 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
              <div class="bg-white dark:bg-neutral-900 px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                <div class="sm:flex sm:items-start">
                  <div
                    class="mx-auto flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-rose-100 dark:bg-rose-600 sm:mx-0 sm:h-10 sm:w-10">
                    <Icon
                      name="uil:exclamation-triangle"
                      class="h-6 w-6 text-rose-600 dark:text-rose-50"
                      aria-hidden="true" />
                  </div>
              ...
              <div
                class="bg-gray-50 dark:bg-neutral-800 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                <button
                  type="button"
