    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "doc_id",
                    models.CharField(db_column="doc-id", max_length=10, unique=True),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "section",
                    models.TextField(
                        blank=True, db_collation="utf8mb4_general_ci", null=True
                    ),
                ),
                (
                    "orig_text",
                ...
                (
                    "format",
                    models.CharField(db_collation="utf8mb4_general_ci", max_length=100),
                ),
            ],
            options={
                "db_table": "errata",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "date_received",
                    models.DateField(blank=True, db_column="DATE_RECEIVED", null=True),
                ),
                (
                    "time_out_date",
                    models.DateField(blank=True, db_column="TIME-OUT-DATE", null=True),
                ),
                (
                    "expedite_need_date",
                    models.CharField(
                ...
                (
                    "type",
                    models.CharField(
                        blank=True, db_column="TYPE", max_length=3, null=True
                    ),
                ),
                (
                    "doc_id",
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        blank=True, db_column="PAGE-COUNT", null=True
                    ),
                ),
                (
                    "pub_status",
                    models.CharField(
                        blank=True, db_column="PUB-STATUS", max_length=21, null=True
                    ),
                ),
                (
                    "status",
                    models.CharField(
                        blank=True, db_column="STATUS", max_length=21, null=True
                    ),
                ),
                (
                    "email",
                ...
                (
                    "pub_date",
                    models.DateField(blank=True, db_column="PUB-DATE", null=True),
                ),
                (
                    "nroffed",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "url_of_change",
                    models.TextField(blank=True, db_column="URL_of_change", null=True),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "draft_name",
                    models.CharField(db_column="DRAFT-NAME", max_length=180),
                ),
                (
                    "draft_version",
                    models.CharField(db_column="DRAFT-VERSION", max_length=20),
                ),
